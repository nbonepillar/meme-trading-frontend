...
export default function HistoryContent() {
  ...
  const { data, isLoading, error } = useUserTransactionHistory({ limit: 50 });
    ...
    return (
      <div className="flex items-center justify-center h-[400px]">
        <div className="text-center">
          <div className="text-red-400 text-sm mb-2">Error loading transaction history</div>
  ...
  return (
    <>
                        ...
                        {transactions.length === 0 ? (
                          <tr>
                            <td colSpan={7} className="text-center py-20">
                              <div className="flex flex-col h-fit w-full justify-center items-center gap-2">
                                <div className="text-center text-sm text-second-font-color">No Transactions</div>
                              </div>
                            </td>
                          </tr>
                        ) : (
                          transactions.map((tx) => {
                            ...
                            const handleRowClick = () => {
                              ...
                              console.log('[HistoryContent] Navigating to token:', {
      ...
      {transactions.length > 0 && (
        <div className="border-t border-custom-border px-4 py-2">
